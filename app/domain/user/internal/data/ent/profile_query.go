...
func (pq *ProfileQuery) FirstID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (pq *ProfileQuery) FirstIDX(ctx context.Context) int64 {
...
func (pq *ProfileQuery) OnlyID(ctx context.Context) (id int64, err error) {
	var ids []int64
...
func (pq *ProfileQuery) OnlyIDX(ctx context.Context) int64 {
...
func (pq *ProfileQuery) IDs(ctx context.Context) (ids []int64, err error) {
...
func (pq *ProfileQuery) IDsX(ctx context.Context) []int64 {
	ids, err := pq.IDs(ctx)
	if err != nil {
		panic(err)
	}
