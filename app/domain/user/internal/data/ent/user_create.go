...
func (uc *UserCreate) SetIdentification(i int) *UserCreate {
	uc.mutation.SetIdentification(i)
	return uc
}

// SetNillableIdentification sets the "identification" field if the given value is not nil.
func (uc *UserCreate) SetNillableIdentification(i *int) *UserCreate {
	if i != nil {
		uc.SetIdentification(*i)
	}
	return uc
}
...
func (uc *UserCreate) AddProfileIDs(ids ...int64) *UserCreate {
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.Identification(); ok {
		_spec.SetField(user.FieldIdentification, field.TypeInt, value)
		_node.Identification = value
	}
